...
public class TestFlinkCatalog {
    public static void main(String[] args) {
        ...
        String createHiveCatalogDDL = "create catalog hive_catalog with (\n" +
                ...
                "    'hive-conf-dir'='D:/idea/stream-dev/stream-realtime/src/main/resources'\n" +
                ")";

        HiveCatalog hiveCatalog = new HiveCatalog("hive-catalog", "default", "D:/idea/stream-dev/stream-realtime/src/main/resources");
